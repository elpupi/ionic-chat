...
export class RootMostResolvePlugin {
    ...
    constructor(context: string, public force?: boolean, public overwriteInvalidSemVer = true) {
    ...
    apply(resolver: EnhancedResolve.Resolver) {
        ...
        const overwriteInvalidSemVer = this.overwriteInvalidSemVer;

        resolver.plugin('module', async function (originalResolved: EnhancedResolve.ResolveResult, callback) {

            console.log(originalResolved);
